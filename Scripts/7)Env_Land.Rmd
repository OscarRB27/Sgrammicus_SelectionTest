...
This script is used for ploting environmental variables. Also to carry out normality tests to test if they follow a normal distribution, which was necessary to know in order to apply the correct test (parametric or non-parametric) to know if there were significant differences between the variables in the different sites within each locality.
...
### 4) Analysis of variables between sites within each polygon
...
Normality test for MSI within each site
